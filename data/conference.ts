export const conference = {
  ...
  highlights: [
    { text: "Selected papers will be published in Scopus Indexed Journals." },
    { text: "Best Paper Awards for each technical session." },
    { text: "Conference Proceedings with ISBN number." },
    { text: "Networking opportunities with international delegates." },
  ],
  ...
  // SECTION 6: SPEAKERS (Missing Details)
  speakers: [
    {
      name: "Dr. J Anitha Menon",
      role: "Head of School - Psychological Sciences",
      institution: "Curtin University, Dubai",
      image: "/images/anitha-menon.jpg",
      details: `I am a Professor of Psychology with extensive leadership experience spanning research, corporate, and education sectors. My journey includes earning a Ph.D. in Psychiatry/Health Psychology from the University of Nottingham, UK. Research and enhancing both employee experiences and overall well-being drive my passion. Over three decades, I've actively engaged in diverse research and service projects relevant to public health, alongside offering mental health services for youth and women. I lead teams in international projects and have contributed over 150 publications to peer-reviewed journals. My work has garnered attention in international media, and I've been honored with several awards. Notably, I received the Labor Day Award from the Government of the Republic of Zambia for Innovation and Excellence, the UK Alumni Award for Professional Achievement, and the African Women Leaders Award in December 2019. Recently, I was honored as the 2022 recipient of the Denmark Gunvald Award for Feminist Research and Service by the International Council of Psychologists.`
    },
    {
      name: "Dr. Lobsang Sangay",
      role: "Sikyong (Former President) & Senior Visiting Fellow",
      institution: "Central Tibetan Administration & Harvard Law School",
      image: "/images/lobsang-sangay.jpg",
      details: `Dr. Lobsang Sangay is a distinguished legal scholar and the first democratically elected leader to assume the secular political authorities of the Dalai Lama. Serving two terms as Sikyong from 2011 to 2021, he led the Central Tibetan Administration through a historic democratic transition, focusing on education, international diplomacy, and the "Middle Way Approach" for Tibetan autonomy. He holds a Doctorate of Juridical Science from Harvard Law School, where he was the first Tibetan to achieve this rank, and he currently serves there as a Senior Visiting Fellow. A prominent global advocate, he was instrumental in the passage of the Tibetan Policy and Support Act in the U.S. and became the first CTA leader to be formally received at the White House. Today, he continues to lecture globally on international law, democratic constitutionalism, and the geopolitical implications of Tibet’s struggle.`
    },
    {
  ...
  registration: {
    categories: [
      { category: "Students (within Parul University)", fee: "₹ 750" },
      { category: "Faculty (within Parul University)", fee: "₹ 900" },
      { category: "Students (Outside)", fee: "₹ 900" },
      { category: "Academician / Faculty (Outside)", fee: "₹ 1200" },
      { category: "Industry / NGO (Outside)", fee: "₹ 1500" },
